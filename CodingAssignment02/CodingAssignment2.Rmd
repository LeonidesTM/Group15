...
```{r q1}
model <- lm(Insurance_Data_Group15$Charges ~ Insurance_Data_Group15$Age + Insurance_Data_Group15$BMI + Insurance_Data_Group15$Children + Insurance_Data_Group15$Female + Insurance_Data_Group15$Smoker + Insurance_Data_Group15$WinterSprings + Insurance_Data_Group15$WinterPark + Insurance_Data_Group15$Oviedo, data = Insurance_Data_Group15)
summary(model)
...
newPrediction <- data.frame(Age = 35, BMI = 26, Children = 1, Female = 1, Smoker = 0, Sanford = 1)

predict(model, charges = newPrediction, interval = "confidence", level = .95)
